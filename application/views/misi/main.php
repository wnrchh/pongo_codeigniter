	...
	<div class="content">
		<div class="panel">
			<div class="content-header no-mg-top">
				...
				<div class="content-header-title">Misi</div>
			</div>
			<div class="row">
				<div class="col-md-12">
...
<script type="text/javascript">
	var datagrid = $("#datagrid").datagrid({
		url						: "<?php echo base_url() . 'misi/data'; ?>",
		primaryField			: 'id', 
		rowNumber				: true,
		...
		columns					: [
	        {field: 'judul1', title: 'Judul1', editable: true, sortable: true, width: 450, align: 'left', search: true},
	        {field: 'judul2', title: 'Judul2', editable: true, sortable: true, width: 450, align: 'left', search: true},	        
  			{field: 'keteranganpendek', title: 'Keterangan', editable: true, sortable: true, width: 150, align: 'center', search: true},
	...
	function create_update_form(rowIndex) {
		$.post("<?php echo base_url() . 'misi/form'; ?>", {index : rowIndex}).done(function(data) {
	...
	function delete_action(rowIndex) {
		swal({   
			...
			$.post("<?php echo base_url() . 'misi/delete'; ?>", {id : row.id}).done(function(data) {
				datagrid.reload();
			});
		});
	}
