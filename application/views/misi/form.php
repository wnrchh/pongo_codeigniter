...
<div class="content">
	<div class="panel">
		<div class="content-header no-mg-top">
			...
			<div class="content-header-title">Misi Form</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="content-box">
					<form id="form-action">
						...
						<div class="form-group">
							...
							<input class="form-control" name="judul1" placeholder="Judul1" type="text">
							<div class="validation-message" data-field="judul1"></div>
						</div>
						<div class="form-group">
							<label for="">Judul2</label>
							<input class="form-control" name="judul2" placeholder="Judul2" type="text">
							<div class="validation-message" data-field="judul2"></div>
						</div>
						<div class="form-group">
							<label for=""> Keterangan</label>
							<textarea class="form-control" id='keterangan' name="keterangan" placeholder="Keterangan"></textarea>
							<textarea class="hidden" id='keterangansimpan' name="keterangansimpan" placeholder="keterangansimpan"></textarea>
...
<script type="text/javascript">
	...
	function validate(formData) {
		...
		$.ajax({
	        url: "<?php echo base_url() . 'misi/validate'; ?>", async: false, type: 'POST', data: formData,
	...
	function save(formData) {
		...
		$.post("<?php echo base_url() . 'misi/action'; ?>", formData).done(function(data) {
