...
<div class="content">
	<div class="panel">
		<div class="content-header no-mg-top">
			...
			<div class="content-header-title">Kelas Form</div>
		</div>
		<div class="row">
			<div class="col-md-6">
				<div class="content-box">
					<form id="form-action">
						...
						<div class="form-group">
							<label for=""> Kelas_id</label>
							<input class="form-control" name="kelas_id" placeholder="Kelas_id" type="text">
							<div class="validation-message" data-field="kelas_id"></div>
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control" name="jumlah" placeholder="Jumlah" type="text">
...
<script type="text/javascript">
	...
	function validate(formData) {
		...
		$.ajax({
	        url: "<?php echo base_url() . 'kelas/validate'; ?>", async: false, type: 'POST', data: formData,
	...
	function save(formData) {
		...
		$.post("<?php echo base_url() . 'kelas/action'; ?>", formData).done(function(data) {
