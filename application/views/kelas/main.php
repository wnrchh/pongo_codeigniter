				...
				<div class="col-md-12">
					<div class="content-box">
						<div class="content-box-header">
							<div class="row">
								<div class="col-md-6">
									<button class="btn btn-primary" onclick="main_routes('create', '')"><i class="fa fa-pencil"></i> Add New Kelas</button>
								</div>
...
<script type="text/javascript">
	var datagrid = $("#datagrid").datagrid({
		...
		columns					: [
	        ...
	        {field: 'kelas', title: 'Kelas', editable: true, sortable: true, width: 450, align: 'left', search: true},
	        {field: 'jumlah', title: 'Jumlah', editable: true, sortable: true, width: 450, align: 'left', search: true},
	...
	function create_update_form(rowIndex) {
		$.post("<?php echo base_url() . 'kelas/form'; ?>", {index : rowIndex}).done(function(data) {
	...
	function delete_action(rowIndex) {
		swal({   
			...
			$.post("<?php echo base_url() . 'kelas/delete'; ?>", {id : row.id}).done(function(data) {
				datagrid.reload();
			});
		});
	}
