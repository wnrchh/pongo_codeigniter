	...
	<div class="content">
		<div class="panel">
			<div class="content-header no-mg-top">
				...
				<div class="content-header-title">Sekolah</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="content-box">
						<div class="content-box-header">
							<div class="row">
								<div class="col-md-3">
									<button class="btn btn-dark" onclick="main_routes('create', '')"><i class="fa fa-pencil"></i> Add New Sekolah</button>
								</div>
...
<script type="text/javascript">
	var datagrid = $("#datagrid").datagrid({
		...
		columns					: [
	       	...
	       	{field: 'kbtk', title: 'KB-TK', editable: true, sortable: true, width: 450, align: 'left', search: true},	        
  			{field: 'sd', title: 'SD', editable: true, sortable: true, width: 150, align: 'center', search: true},
  			{field: 'smp', title: 'SMP', editable: true, sortable: true, width: 450, align: 'left', search: true},	        
  			{field: 'sma', title: 'SMA', editable: true, sortable: true, width: 150, align: 'center', search: true},
  			{field: 'smk', title: 'SMK', editable: true, sortable: true, width: 450, align: 'left', search: true},	        
