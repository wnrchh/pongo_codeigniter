<div class="breadcrumb">
	<a href="">Home</a> 
	<a href="">Karyawan Form</a>
</div>
<div class="content">
	<div class="panel">
		<div class="content-header no-mg-top">
			<i class="fa fa-newspaper-o"></i>
			<div class="content-header-title">Karyawan Form</div>
		</div>
		<div class="row">
			<div class="col-md-6">
				<div class="content-box">
					<form id="form-action">
						...
						<div class="form-group">
							...
							<input class="form-control" name="no_hp" placeholder="NO HP" type="text">
						...
						<option value="Kebersihan">Kebersihan</option>
							...
							<div class="validation-message" data-field="pekerjaan"></div>
						</div>			
						<div class="form-group">
...
<script type="text/javascript">
	...
	function validate(formData) {
		...
		$.ajax({
	        url: "<?php echo base_url() . 'karyawan/validate'; ?>", async: false, type: 'POST', data: formData,
	...
	function save(formData) {
		...
		$.post("<?php echo base_url() . 'karyawan/action'; ?>", formData).done(function(data) {
