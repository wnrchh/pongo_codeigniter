	...
	<div class="content">
		<div class="panel">
			<div class="content-header no-mg-top">
				...
				<div class="content-header-title">Karyawan</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="content-box">
						<div class="content-box-header">
							<div class="row">
								<div class="col-md-6">
									<button class="btn btn-primary" onclick="main_routes('create', '')"><i class="fa fa-pencil"></i> Add New Karyawan</button>
								</div>
...
<script type="text/javascript">
	var datagrid = $("#datagrid").datagrid({
		...
		columns					: [
	        {field: 'nama', title: 'Nama', editable: true, sortable: true, width: 450, align: 'left', search: true},	        
  			{field: 'pekerjaan', title: 'Pekerjaan', editable: true, sortable: true, width: 150, align: 'center', search: true},
	        {field: 'images_format', title: 'Foto', sortable: false, width: '', align: 'center', search: false, 
...
function images_format(rowData, rowIndex) {
	...
	function create_update_form(rowIndex) {
		$.post("<?php echo base_url() . 'karyawan/form'; ?>", {index : rowIndex}).done(function(data) {
	...
	function delete_action(rowIndex) {
		swal({   
			...
			var row = datagrid.getRowData(rowIndex);
			$.post("<?php echo base_url() . 'karyawan/delete'; ?>", {id : row.id}).done(function(data) {
				datagrid.reload();
			});
		});
	}
