				...
				<div class="col-md-12">
					<div class="content-box">
						<div class="content-box-header">
							<div class="row">
								<div class="col-md-3">
									<button class="btn btn-dark" onclick="main_routes('create', '')"><i class="fa fa-pencil"></i> Add New Gallery</button>
								</div>
...
function images_format(rowData, rowIndex) {
	...
	function create_update_form(rowIndex) {
		$.post("<?php echo base_url() . 'gallery/form'; ?>", {index : rowIndex}).done(function(data) {
	...
	function delete_action(rowIndex) {
		swal({   
			...
			var row = datagrid.getRowData(rowIndex);
			$.post("<?php echo base_url() . 'gallery/delete'; ?>", {id : row.id}).done(function(data) {
				datagrid.reload();
			});
		});
	}
