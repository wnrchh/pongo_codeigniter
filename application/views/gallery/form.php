...
<div class="content">
	<div class="panel">
		<div class="content-header no-mg-top">
			...
			<div class="content-header-title">Gallery Form</div>
		</div>
		<div class="row">
			<div class="col-md-6">
...
<script type="text/javascript">
	...
	function validate(formData) {
		...
		$.ajax({
	        url: "<?php echo base_url() . 'gallery/validate'; ?>", async: false, type: 'POST', data: formData,
	...
	function save(formData) {
		...
		$.post("<?php echo base_url() . 'gallery/action'; ?>", formData).done(function(data) {
