...
foreach ($mata_pelajaran as $key => $value) {
	...
	$q_nilai = $this->db->query("SELECT nilai_angka, nilai_huruf , keterangan FROM nilai WHERE siswa_id = '$siswa_id' AND mata_pelajaran_id = '$value->id'")->row();
...
$no++;
 ?>
									...
									<tr>
										...
										<td><input class="form-control" onkeyup="hitung_nilai(this.value, '<?=$value->id?>'); hitung_keterangan(this.value, '<?=$value->id?>');" name="nilai_angka_<?=$value->id?>" placeholder="Nilai Angka" type="number" value="<?=$q_nilai->nilai_angka?>"></td>
										<td><select class="form-control" id="tampil_nilai_<?=$value->id?>" name="nilai_huruf_<?=$value->id?>" placeholder="Nilai Huruf" type="text">
											<option value="<?=$q_nilai->nilai_huruf?>"><?=$q_nilai->nilai_huruf?></option>
										</select></td>
										<td><select class="form-control" id="tampil_keterangan_<?=$value->id?>" name="keterangan_<?=$value->id?>" placeholder="Keterangan" type="text">
											<option value="<?=$q_nilai->keterangan?>"><?=$q_nilai->keterangan?></option>
										</select></td>
