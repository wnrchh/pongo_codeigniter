<div class="breadcrumb">
	<a href="">Home</a> 
	<a href="">Berita Form</a>
</div>
<div class="content">
	<div class="panel">
		<div class="content-header no-mg-top">
			<i class="fa fa-newspaper-o"></i>
			<div class="content-header-title">Berita Form</div>
		</div>
		<div class="row">
			<div class="col-md-6">
...
<script type="text/javascript">
	...
	function validate(formData) {
		...
		$.ajax({
	        url: "<?php echo base_url() . 'berita/validate'; ?>", async: false, type: 'POST', data: formData,
	...
	function save(formData) {
		...
		$.post("<?php echo base_url() . 'berita/action'; ?>", formData).done(function(data) {
