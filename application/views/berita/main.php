	...
	<div class="content">
		<div class="panel">
			<div class="content-header no-mg-top">
				...
				<div class="content-header-title">Berita</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="content-box">
						<div class="content-box-header">
							<div class="row">
								<div class="col-md-3">
									<button class="btn btn-dark" onclick="main_routes('create', '')"><i class="fa fa-pencil"></i> Add New Berita</button>
								</div>
	...
	var datagrid = $("#datagrid").datagrid({
		...
		columns					: [
	       ...
	       {field: 'images_format', title: 'foto', sortable: false, width: 200, align: 'center', search: false, 
	       	...
	       	{field: 'judul', title: 'Judul', editable: true, sortable: true, width: 450, align: 'left', search: true},	        
  			{field: 'keterangan', title: 'Keterangan', editable: true, sortable: true, width: 150, align: 'center', search: true},
...
function images_format(rowData, rowIndex) {
	...
	function create_update_form(rowIndex) {
		$.post("<?php echo base_url() . 'berita/form'; ?>", {index : rowIndex}).done(function(data) {
	...
	function delete_action(rowIndex) {
		swal({   
			...
			var row = datagrid.getRowData(rowIndex);
			$.post("<?php echo base_url() . 'berita/delete'; ?>", {id : row.id}).done(function(data) {
				datagrid.reload();
			});
		});
	}
