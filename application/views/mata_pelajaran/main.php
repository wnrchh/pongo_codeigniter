	...
	<div class="content">
		<div class="panel">
			<div class="content-header no-mg-top">
				...
				<div class="content-header-title">Mata Pelajaran</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="content-box">
						<div class="content-box-header">
							<div class="row">
								<div class="col-md-6">
									<button class="btn btn-primary" onclick="main_routes('create', '')"><i class="fa fa-pencil"></i> Add New Mata Pelajaran</button>
								</div>
...
<script type="text/javascript">
	var datagrid = $("#datagrid").datagrid({
		url						: "<?php echo base_url() . 'mata_pelajaran/data'; ?>",
		primaryField			: 'id', 
		rowNumber				: true,
		...
		columns					: [
	        ...
	        {field: 'guru', title: 'Guru', editable: true, sortable: true, width: 450, align: 'left', search: true},
	        {field: 'guru2', title: 'Guru2', editable: true, sortable: true, width: 450, align: 'left', search: true},
	...
	function create_update_form(rowIndex) {
		$.post("<?php echo base_url() . 'mata_pelajaran/form'; ?>", {index : rowIndex}).done(function(data) {
	...
	function delete_action(rowIndex) {
		swal({   
			...
			$.post("<?php echo base_url() . 'mata_pelajaran/delete'; ?>", {id : row.id}).done(function(data) {
				datagrid.reload();
			});
		});
	}
