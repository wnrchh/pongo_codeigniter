...
$(function () {
	...
	if ($('#donut-chart').length) {
		...
		var data = {
			...
			datasets: [{
				data: [200, 100, 80],
				backgroundColor: ["#D61355", "#FCE22A", "#30E3DF"],
				hoverBackgroundColor: ["#D61355", "#FCE22A", "#30E3DF"],
				borderWidth: 0
			}]
		};
	...
	if ($('#line-chart1').length) {
		...
		var lineData = {
			...
			datasets: [{
				...
				pointRadius: 6,
				pointHitRadius: 10,
				data: [1000000, 2500000, 3200000, 1450000, 3120000,5500000, 5250000,3400000,2050000,2500000,4300000],
				spanGaps: false
			}]
		};
